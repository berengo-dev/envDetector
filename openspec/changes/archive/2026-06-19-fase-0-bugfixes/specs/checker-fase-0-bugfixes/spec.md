# Spec: Fase 0 Bugfixes — env-doctor

## Purpose

Close six correctness and hygiene bugs blocking a reliable public release: 0.1–0.4 produce wrong check results, 0.5 breaks Go process hygiene via `os.Exit` in a `RunE` handler, and 0.6 leaves a compiled binary tracked in git.

## Domain: checker-fase-0-bugfixes
